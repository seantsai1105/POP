...
import torch
try:
    from model.vlm_modules.internvl3.internvl.model.internvl_chat import InternVLChatConfig, InternVLChatModel
except:
...
def load_model_and_tokenizer(args):
    checkpoint = args.checkpoint if 'checkpoint' in args else args.vlm_checkpoint
    # if args.auto:
    ...
    model = InternVLChatModel.from_pretrained(checkpoint, low_cpu_mem_usage=True, torch_dtype=torch.bfloat16, device_map=args.device).eval()
