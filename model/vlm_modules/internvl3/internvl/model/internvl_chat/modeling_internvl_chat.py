...
try:
    ...
    from model.vlm_modules.internvl3.internvl.model.internlm2.modeling_internlm2 import InternLM2ForCausalLM
    from model.vlm_modules.internvl3.internvl.model.phi3.modeling_phi3 import Phi3ForCausalLM
...
class InternVLChatModel(PreTrainedModel):
    ...
    def chat(self, tokenizer, pixel_values, question, generation_config, history=None, return_history=False,
        ...
        generation_config['eos_token_id'] = eos_token_id
        generation_output = self.generate(
            pixel_values=pixel_values.to(device, self.language_model.dtype),
            input_ids=input_ids,
            attention_mask=attention_mask,
            **generation_config
        )
