...
class Dinov3Module():
    ...
    def get_reference_features(
        ...
        reference_last_hidden_state = reference_outputs.last_hidden_state[0, 5:, :] 
    ...
    def get_image_to_image_score(
        ...
        target_last_hidden_state = target_outputs.last_hidden_state[0, 5:, :] 
